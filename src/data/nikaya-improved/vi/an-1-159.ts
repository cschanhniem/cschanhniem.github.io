// Improved Vietnamese Translation - AN 1.159
// NhậpLưu 2026 Translation

import type { ImprovedTranslation } from '@/types/nikaya'

export const an1_159: ImprovedTranslation = {
    suttaId: 'an1.159',
    lang: 'vi',
    author: 'NhậpLưu Translation Team',
    year: '2026',
    title: 'Kinh Tội Không Thể Sám Hối Là Tội Có Thể Sám Hối - Làm Chánh Pháp Biến Mất',
    content: `
# Kinh Tội Không Thể Sám Hối Là Tội Có Thể Sám Hối
## AN 1.159
...
> "Này các tỷ-kheo, những tỷ-kheo nào giảng giải tội không thể sám hối (không thể chuộc lỗi) là tội có thể sám hối; các vị ấy đang hành động gây bất hạnh và đau khổ cho số đông, đi ngược lại số đông, đem đến tai hại, bất hạnh và đau khổ cho chư thiên và loài người. Những vị ấy tích tựu vô vàn ác nghiệp và làm cho chánh pháp biến mất."
