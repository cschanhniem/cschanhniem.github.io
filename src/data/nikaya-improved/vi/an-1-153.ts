// Improved Vietnamese Translation - AN 1.153
// NhậpLưu 2026 Translation

import type { ImprovedTranslation } from '@/types/nikaya'

export const an1_153: ImprovedTranslation = {
    suttaId: 'an1.153',
    lang: 'vi',
    author: 'NhậpLưu Translation Team',
    year: '2026',
    title: 'Kinh Tội Nặng Là Tội Nhẹ - Làm Chánh Pháp Biến Mất',
    content: `
# Kinh Tội Nặng Là Tội Nhẹ
## AN 1.153
...
> "Này các tỷ-kheo, những tỷ-kheo nào giảng giải tội nặng là tội nhẹ; các vị ấy đang hành động gây bất hạnh và đau khổ cho số đông, đi ngược lại số đông, đem đến tai hại, bất hạnh và đau khổ cho chư thiên và loài người. Những vị ấy tích tựu vô vàn ác nghiệp và làm cho chánh pháp biến mất."
