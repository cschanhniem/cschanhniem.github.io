// Improved Vietnamese Translation - AN 1.164
// NhậpLưu 2026 Translation

import type { ImprovedTranslation } from '@/types/nikaya'

export const an1_164: ImprovedTranslation = {
    suttaId: 'an1.164',
    lang: 'vi',
    author: 'NhậpLưu Translation Team',
    year: '2026',
    title: 'Kinh Tội Thô Trọng Là Tội Thô Trọng - Giữ Chánh Pháp Trường Tồn',
    content: `
# Kinh Tội Thô Trọng Là Tội Thô Trọng
## AN 1.164
...
> "Này các tỷ-kheo, những tỷ-kheo nào giảng giải tội thô trọng là tội thô trọng; các vị ấy đang hành động đem lại lợi ích và hạnh phúc cho số đông, thuận vì số đông, đem đến phúc lợi, lợi ích và hạnh phúc cho chư thiên và loài người. Những vị ấy tích tựu vô vàn phước báu và làm cho chánh pháp trường tồn."
