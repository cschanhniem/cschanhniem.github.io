// Improved Vietnamese Translation - AN 1.151
// NhậpLưu 2026 Translation

import type { ImprovedTranslation } from '@/types/nikaya'

export const an1_151: ImprovedTranslation = {
    suttaId: 'an1.151',
    lang: 'vi',
    author: 'NhậpLưu Translation Team',
    year: '2026',
    title: 'Kinh Điều Có Phạm Là Vô Phạm - Làm Chánh Pháp Biến Mất',
    content: `
# Kinh Điều Có Phạm Là Vô Phạm
## AN 1.151
...
> "Này các tỷ-kheo, những tỷ-kheo nào giảng giải điều có phạm là vô phạm; các vị ấy đang hành động gây bất hạnh và đau khổ cho số đông, đi ngược lại số đông, đem đến tai hại, bất hạnh và đau khổ cho chư thiên và loài người. Những vị ấy tích tựu vô vàn ác nghiệp và làm cho chánh pháp biến mất."
