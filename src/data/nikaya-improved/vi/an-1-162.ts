// Improved Vietnamese Translation - AN 1.162
// NhậpLưu 2026 Translation

import type { ImprovedTranslation } from '@/types/nikaya'

export const an1_162: ImprovedTranslation = {
    suttaId: 'an1.162',
    lang: 'vi',
    author: 'NhậpLưu Translation Team',
    year: '2026',
    title: 'Kinh Tội Nhẹ Là Tội Nhẹ - Giữ Chánh Pháp Trường Tồn',
    content: `
# Kinh Tội Nhẹ Là Tội Nhẹ
## AN 1.162
...
> "Này các tỷ-kheo, những tỷ-kheo nào giảng giải tội nhẹ là tội nhẹ; các vị ấy đang hành động đem lại lợi ích và hạnh phúc cho số đông, thuận vì số đông, đem đến phúc lợi, lợi ích và hạnh phúc cho chư thiên và loài người. Những vị ấy tích tựu vô vàn phước báu và làm cho chánh pháp trường tồn."
