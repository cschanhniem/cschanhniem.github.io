// Improved Vietnamese Translation - AN 1.161
// NhậpLưu 2026 Translation

import type { ImprovedTranslation } from '@/types/nikaya'

export const an1_161: ImprovedTranslation = {
    suttaId: 'an1.161',
    lang: 'vi',
    author: 'NhậpLưu Translation Team',
    year: '2026',
    title: 'Kinh Điều Có Phạm Là Có Phạm - Giữ Chánh Pháp Trường Tồn',
    content: `
# Kinh Điều Có Phạm Là Có Phạm
## AN 1.161
...
> "Này các tỷ-kheo, những tỷ-kheo nào giảng giải điều có phạm là có phạm; các vị ấy đang hành động đem lại lợi ích và hạnh phúc cho số đông, thuận vì số đông, đem đến phúc lợi, lợi ích và hạnh phúc cho chư thiên và loài người. Những vị ấy tích tựu vô vàn phước báu và làm cho chánh pháp trường tồn."
