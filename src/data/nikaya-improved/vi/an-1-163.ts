// Improved Vietnamese Translation - AN 1.163
// NhậpLưu 2026 Translation

import type { ImprovedTranslation } from '@/types/nikaya'

export const an1_163: ImprovedTranslation = {
    suttaId: 'an1.163',
    lang: 'vi',
    author: 'NhậpLưu Translation Team',
    year: '2026',
    title: 'Kinh Tội Nặng Là Tội Nặng - Giữ Chánh Pháp Trường Tồn',
    content: `
# Kinh Tội Nặng Là Tội Nặng
## AN 1.163
...
> "Này các tỷ-kheo, những tỷ-kheo nào giảng giải tội nặng là tội nặng; các vị ấy đang hành động đem lại lợi ích và hạnh phúc cho số đông, thuận vì số đông, đem đến phúc lợi, lợi ích và hạnh phúc cho chư thiên và loài người. Những vị ấy tích tựu vô vàn phước báu và làm cho chánh pháp trường tồn."
