// Improved Vietnamese Translation - AN 1.150
// NhậpLưu 2026 Translation

import type { ImprovedTranslation } from '@/types/nikaya'

export const an1_150: ImprovedTranslation = {
    suttaId: 'an1.150',
    lang: 'vi',
    author: 'NhậpLưu Translation Team',
    year: '2026',
    title: 'Kinh Điều Vô Phạm Là Có Phạm - Làm Chánh Pháp Biến Mất',
    content: `
# Kinh Điều Vô Phạm Là Có Phạm
## AN 1.150
...
> "Này các tỷ-kheo, những tỷ-kheo nào giảng giải điều vô phạm là có phạm; các vị ấy đang hành động gây bất hạnh và đau khổ cho số đông, đi ngược lại số đông, đem đến tai hại, bất hạnh và đau khổ cho chư thiên và loài người. Những vị ấy tích tựu vô vàn ác nghiệp và làm cho chánh pháp biến mất."
