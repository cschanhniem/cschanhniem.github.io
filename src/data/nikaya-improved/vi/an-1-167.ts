// Improved Vietnamese Translation - AN 1.167
// NhậpLưu 2026 Translation

import type { ImprovedTranslation } from '@/types/nikaya'

export const an1_167: ImprovedTranslation = {
    suttaId: 'an1.167',
    lang: 'vi',
    author: 'NhậpLưu Translation Team',
    year: '2026',
    title: 'Kinh Tội Không Cần Phục Hồi Là Tội Không Cần Phục Hồi - Giữ Chánh Pháp Trường Tồn',
    content: `
# Kinh Tội Không Cần Phục Hồi Là Tội Không Cần Phục Hồi
## AN 1.167
...
> "Này các tỷ-kheo, những tỷ-kheo nào giảng giải tội không cần phục hồi là tội không cần phục hồi; các vị ấy đang hành động đem lại lợi ích và hạnh phúc cho số đông, thuận vì số đông, đem đến phúc lợi, lợi ích và hạnh phúc cho chư thiên và loài người. Những vị ấy tích tựu vô vàn phước báu và làm cho chánh pháp trường tồn."
...
> **Ghi chú dịch thuật**: Cụm từ *tích tựu vô vàn phước báu* được diễn đạt bám sát nhịp điệu *brim with much merit* (pasavanti puññaṃ), tạo sức đối kháng với *ác nghiệp* (apuññaṃ) của nhóm bài trước.
`
}
